...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2015 at 11:37 AM
...
INSERT INTO `books` (`id`, `group_id`, `subject_id`, `book_code`, `book_name`, `rate`, `status`) VALUES
(1, 1, 4, 'HT2015-1', 'HHC Test paper 2015', 250, 1),
(2, 2, 3, 'HEG-8525-5', 'HSC English Grammer ', 750, 1),
(3, 3, 4, 'BOOK002', 'English For Today', 333, 1),
(4, 3, 1, 'sdsdfsafd', 'Test', 44, 1);
...
(5, 56, 311, 4, 7, 13, 'Rangpur Government College', 'Just For Testing ', 1);
...
(3, '2015-11-04 08:26:20', '2015-11-04', 4, 4, '13', 'sadadada', 1);
...
CREATE TABLE `inventory_college` (
  `id` int(11) NOT NULL,
  `college_id` int(11) NOT NULL,
...
CREATE TABLE `inventory_division` (
  `id` int(11) NOT NULL,
  `division_id` int(11) NOT NULL,
...
INSERT INTO `tbl_subject` (`id`, `subject_name`, `subject_code`, `status`) VALUES
(1, 'Test', 'Test', 1),
(2, 'Test', 'Test', 1),
(3, 'Test2', 'Test2', 1),
(4, 'Test3', 'Test3', 1);
...
(2, 3, 6, 'abc', '                                                                                                            ', 1),
(3, 5, 3, 'XYZ ', 'Just For Testing', 1),
(4, 4, 2, 'Istiaque sir', 'testing', 1);
...
(4, '2015-11-03 14:21:48', '2015-11-03', '11', 0, 1, 0, 0, '2', ' ', 1),
(5, '2015-11-04 06:37:51', '2015-11-04', '789', 0, 3, 0, 0, '2', ' Just For Testing Purpose ', 1),
(6, '2015-11-04 06:55:21', '2015-11-04', '789', 0, 5, 0, 0, '2', ' just for testing', 1),
(7, '2015-11-04 06:56:52', '2015-11-04', '3', 0, 4, 0, 0, '2', ' sdfsfsd', 1),
(8, '2015-11-04 07:07:50', '2015-11-04', '11', 2, 1, 0, 0, '2', ' Just for testing', 1),
(9, '2015-11-04 07:14:02', '2015-11-04', '3', 0, 5, 0, 0, '2', ' fddgdgd', 1),
(10, '2015-11-04 09:36:36', '2015-11-04', '123', 0, 5, 0, 0, '2', ' Just For Testing', 1),
(11, '2015-11-04 09:42:14', '2015-11-04', '789', 0, 5, 0, 0, '2', ' sdfsdf', 1);
...
(2, 'Tasfir Hossain', 'suman.jpg', 'House#01, Road# 06, Block# C, Banasree, Rampura', 'tasfir_suman@yahoo.com', 'e10adc3949ba59abbe56e057f20f883e', '01911198784', '1', 0, 1, 0, 0, '1'),
